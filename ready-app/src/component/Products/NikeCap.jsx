...
import imgmain from '../Photos/nike-cap.webp'
      ...
      <div className='bg-purple-50 w-11/12 rounded-xl mx-auto px-10 py-3 mb-4'>
        <div className='lg:flex flex-col'>
          <div className='lg:flex lg:justify-between my-3'>
            ...
            <p className='font-medium text-lg text-[#8f0fff]'>Nike Black Cap</p>
            <p className='text-lg'>Price <b>Rs.399</b></p>
        ...
        <div className='mx-5 lg:mr-14 lg:ml-7 md:w-6/12'>
          <div className='bg-white p-5 mx-auto rounded-xl mb-4'>
            <div className='flex justify-between'>
              <h1 className='text-[#8f0fff] font-semibold text-xl'>Nike Black Cap</h1>
              <h1 className='font-medium text-xl'>Rs.399</h1>
            </div>
            <div className='my-2'>
            ...
            <div className='my-4'>
              ...
              <p>Black baseball cap for men</p>
            </div>
