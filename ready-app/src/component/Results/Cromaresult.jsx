...
import data from '../../Data/cromaproducts'
    ...
    <div className="mb-24">
      ...
      </div>
      {
        data.products.map(product => (
            <Searchresultlist img={product.image} title={product.name} dist={product.price} deltime='Delivery in 1 hr' rating='⭐⭐⭐⭐⭐ (200)' btn_text='Add To Cart' next={product.slug}/>   
        ))
      }
    </div>
  );
