...
function Getstarted() {
  return (
    <div>
      ...
      <Link to="/seller-signup"><button className='bg-[#8F00FF] text-white rounded-full px-12 py-2 mx-20 my-5 drop-shadow hover:bg-white hover:text-[#8f0fff] ease-in-out transition duration-200' type="submit">GET STARTED</button></Link>
      </div>
        ...
        <div className='flow-root items-center md:w-full'>
          ...
          <div className='md:flex text-white mx-20 my-24 md:items-center'>
            ...
            <Link to="/seller-signup"><button className='bg-[#8F00FF] text-white rounded-full px-12 py-2 mx-auto my-5 drop-shadow hover:bg-white hover:text-[#8f0fff] ease-in-out transition duration-200' type="submit">GET STARTED</button></Link>
          </div>
    </div>
  )
}
