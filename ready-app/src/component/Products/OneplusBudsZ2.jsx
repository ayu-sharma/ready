...
import imgmain from '../Photos/oneplus-z3.jpg'
      ...
      <div className='bg-purple-50 w-11/12 rounded-xl mx-auto px-10 py-3 mb-4'>
        <div className='lg:flex flex-col'>
          <div className='lg:flex lg:justify-between my-3'>
            ...
            <p className='font-medium text-lg text-[#8f0fff]'>Oneplus Buds Z2</p>
            <p className='text-lg'>Price <b>Rs.4599</b></p>
        ...
        <div className='mx-5 lg:mr-14 lg:ml-7 md:w-6/12'>
          <div className='bg-white p-5 mx-auto rounded-xl mb-4'>
            <div className='flex justify-between'>
              <h1 className='text-[#8f0fff] font-semibold text-xl'>Oneplus Buds Z2</h1>
              <h1 className='font-medium text-xl'>Rs.4599</h1>
            </div>
            <div className='my-2'>
            ...
            <div className='my-4'>
              ...
              <p>Buds Z2 is the perfect one if you want to get the best out of the battery in any of the true wireless. The buds Z2 comes with Bluetooth 5.0.</p>
            </div>
