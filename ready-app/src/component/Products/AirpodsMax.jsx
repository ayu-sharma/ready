...
import imgmain from '../Photos/airpods-max.jpeg'
      ...
      <div className='bg-purple-50 w-11/12 rounded-xl mx-auto px-10 py-3 mb-4'>
        <div className='lg:flex flex-col'>
          <div className='lg:flex lg:justify-between my-3'>
            ...
            <p className='font-medium text-lg text-[#8f0fff]'>Apple Airpods Max</p>
            <p className='text-lg'>Price <b>Rs.30999</b></p>
        ...
        <div className='mx-5 lg:mr-14 lg:ml-7 md:w-6/12'>
          <div className='bg-white p-5 mx-auto rounded-xl mb-4'>
            <div className='flex justify-between'>
              <h1 className='text-[#8f0fff] font-semibold text-xl'>Apple Airpods Max</h1>
              <h1 className='font-medium text-xl'>Rs.30999</h1>
            </div>
            <div className='my-2'>
            ...
            <div className='my-4'>
              ...
              <p>AirPods Max combine high-fidelity audio with industry-leading Active Noise Cancellation to deliver an unparalleled listening experience. Each part of their custom-built driver works to produce sound with ultra-low distortion across the audible range.</p>
            </div>
