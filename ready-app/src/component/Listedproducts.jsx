...
function Listedproducts() {
  return (
    ...
    <div className='md:flow-root md:mr-10 mb-2 mx-auto'>
      <Link to='/add-product'><button className='drop-shadow-xl align-center md:float-right bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br text-white rounded-full px-12 py-2 my-4 mx-4 font-semibold' type="submit">Add</button></Link>
    </div>
    </div>
    </div>
  )
