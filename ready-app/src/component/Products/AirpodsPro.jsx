...
import imgmain from '../Photos/airpods.jpg'
    ...
    <div className='min-h-screen'>
      ...
      <div className='bg-purple-50 w-11/12 rounded-xl mx-auto px-10 py-3 mb-4'>
        <div className='lg:flex flex-col'>
          <div className='lg:flex lg:justify-between my-3'>
            ...
            <p className='font-medium text-lg text-[#8f0fff]'>Apple Airpods Pro</p>
            <p className='text-lg'>Price <b>Rs.11999</b></p>
      ...
      <div className='lg:flex mb-14 mx-auto'>
        <div className='bg-white py-5 px-5 rounded-xl lg:ml-14 lg:mr-7 mx-5 mb-4'>
          <img className='flex rounded mx-auto w-[35rem]' src={imgmain} alt=""/>
        </div>
        <div className='mx-5 lg:mr-14 lg:ml-7 md:w-6/12'>
          <div className='bg-white p-5 mx-auto rounded-xl mb-4'>
            <div className='flex justify-between'>
              <h1 className='text-[#8f0fff] font-semibold text-xl'>Apple Airpods Pro</h1>
              <h1 className='font-medium text-xl'>Rs.11999</h1>
            </div>
            <div className='my-2'>
            ...
            <div className='my-4'>
              ...
              <p>AirPods Pro have been re-engineered for even richer audio experiences. Next-level Active Noise Cancellation and Adaptive Transparency reduce more external noise. Spatial Audio takes immersion to a remarkably personal level. Touch control now lets you adjust volume with a swipe.</p>
            </div>
