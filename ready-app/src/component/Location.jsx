  ...
  return (
    <div className='min-h-screen items-center mx-auto md:block md:flex md:flex-col md:mx-20 mt-14 mb-14'>
        <div className='drop-shadow-2xl flex flex-col bg-white items-center justify-center rounded-xl mx-10 px-18 pb-8 mt-14 md:w-7/12'>
            ...
            <input type="text" className='my-5 px-2 py-2 shadow-inner bg-[#D9D9D9] text-black border-[#888888] border-solid border rounded-lg text-l w-8/12' placeholder='Location'/>
            <Link to="/ecom-home" className="button bg-[#8F00FF] text-white rounded-full px-12 py-2  hover:bg-[#661D9F] mt-4">ENTER</Link>
        </div>
    </div>
  )
}
