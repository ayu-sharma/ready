...
function Sellerloginpage() {
  return (
    ...
    <div>
       <h1 className="hidden md:text-white md:grid md:mx-12  md:text-2xl">Sign in and start growing your online store.</h1>
    </div>  
...
<h4 className='md:hidden px-6 font-light'>Sign in and grow your business.</h4>
  ...
  <Link to="/store-dashboard"><button className='bg-[#8F00FF] text-white rounded-full px-12 py-2  hover:bg-[#661D9F] mt-4' type="submit">SIGN IN</button></Link>
<h6 className='font-normal text-sm pb-9 pt-2'>Not registered yet? <a className='text-blue-600' href="/seller-signup">Sign Up</a></h6>
</label>
</form>
  </div>
  )
