...
import imgmain from '../Photos/macbook-air-m2.jpeg'
      ...
      <div className='bg-purple-50 w-11/12 rounded-xl mx-auto px-10 py-3 mb-4'>
        <div className='lg:flex flex-col'>
          <div className='lg:flex lg:justify-between my-3'>
            ...
            <p className='font-medium text-lg text-[#8f0fff]'>Apple Macbook Air M2</p>
            <p className='text-lg'>Price <b>Rs.110999</b></p>
        ...
        <div className='mx-5 lg:mr-14 lg:ml-7 md:w-6/12'>
          <div className='bg-white p-5 mx-auto rounded-xl mb-4'>
            <div className='flex justify-between'>
              <h1 className='text-[#8f0fff] font-semibold text-xl'>Apple Macbook Air M2</h1>
              <h1 className='font-medium text-xl'>Rs.110999</h1>
            </div>
            <div className='my-2'>
            ...
            <div className='my-4'>
              ...
              <p>The new MacBook Air is a success on virtually every level. It's got a better screen, thinner and lighter design, better speakers, a much-improved webcam, an excellent keyboard and trackpad, more convenient charging, and excellent build quality.</p>
            </div>
