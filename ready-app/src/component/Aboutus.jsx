...
function Aboutus() {
  return (
    <div className='container drop-shadow bg-white mx-auto mt-14 mb-24 align-center w-10/12 md:flow-root rounded-lg flex md:block flex-col items-center justify-center border-2 border-slate-200'>
