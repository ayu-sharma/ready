    ...
    <div className="mb-24">
      ...
      </div>
      {
        data.products.map(product => (
            <Searchresultlist img={product.image} title={product.name} dist={product.price} deltime='Delivery in 20 min' rating='⭐⭐⭐⭐ (1098)' btn_text='Add To Cart' next={product.slug}/>   
        ))
      }
    </div>
  );
