...
import imgmain from '../Photos/iphone-14.jpg'
      ...
      <div className='bg-purple-50 w-11/12 rounded-xl mx-auto px-10 py-3 mb-4'>
        <div className='lg:flex flex-col'>
          <div className='lg:flex lg:justify-between my-3'>
            ...
            <p className='font-medium text-lg text-[#8f0fff]'>Apple iPhone 14 Pro</p>
            <p className='text-lg'>Price <b>Rs.120999</b></p>
        ...
        <div className='mx-5 lg:mr-14 lg:ml-7 md:w-6/12'>
          <div className='bg-white p-5 mx-auto rounded-xl mb-4'>
            <div className='flex justify-between'>
              <h1 className='text-[#8f0fff] font-semibold text-xl'>Apple iPhone 14 Pro</h1>
              <h1 className='font-medium text-xl'>Rs.120999</h1>
            </div>
            <div className='my-2'>
            ...
            <div className='my-4'>
              ...
              <p>The iPhone 14 Pro and Pro Max feature a Super Retina XDR OLED display with a typical maximum brightness of 1,000 nits. However, it can go all the way up to 1,600 nits while watching HDR videos, and 2,000 nits outdoors. The display has a refresh rate of 120 Hz and utilizes LTPO technology.</p>
            </div>
